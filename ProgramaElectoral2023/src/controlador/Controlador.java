...
public class Controlador implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if("Andalucía".equalsIgnoreCase(comunidadSelecionado)) {
			...
			ChartPanel panelBar8 = crearGraficosBarras(votoscomunidad,nmvotosCastillayLeónx,nmvotosCastillayLeóny,nmvotosCastillayLeónw,nmvotosCastillayLeónz);
			vista.visualizargraficas.add(panelBar8);
			vista.visualizargraficas.setVisible(true);
			calcularGanador(nmvotosCastillayLeónx,nmvotosCastillayLeóny,nmvotosCastillayLeónw,nmvotosCastillayLeónz);
			...
			ChartPanel panelBar9 = crearGraficosBarras(votoscomunidad,nmvotosCataluñax,nmvotosCataluñay,nmvotosCataluñaw,nmvotosCataluñaz);
			vista.visualizargraficas.add(panelBar9);
			vista.visualizargraficas.setVisible(true);
			calcularGanador(nmvotosCataluñax,nmvotosCataluñay,nmvotosCataluñaw,nmvotosCataluñaz);
